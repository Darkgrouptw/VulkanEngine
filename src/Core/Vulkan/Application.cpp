...
#pragma region Private
	...
	{
		WindowM->CreateWindowSurface(VulkanM->GetVKInstance(), &Surface);
...
#pragma region Surface
		vkDestroySurfaceKHR(VulkanM->GetVKInstance(), Surface, nullptr);
#pragma endregion
...
#pragma endregion
	...
	void Application::__PickPhysicalDevice()
	{
		...
		vkEnumeratePhysicalDevices(VulkanM->GetVKInstance(), &deviceCount, nullptr);						// 抓出所有支援的 Device
		if (deviceCount == 0)
		...
		vkEnumeratePhysicalDevices(VulkanM->GetVKInstance(), &deviceCount, devices.data());
...
#pragma endregion
	...
	VkExtent2D Application::__ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
	{
		...
		auto actualExtent = WindowM->GetExtentSize();
